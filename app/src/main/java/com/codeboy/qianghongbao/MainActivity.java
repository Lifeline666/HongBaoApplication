...
import com.codeboy.qianghongbao.lifeline.RealMachineTestActivity;
...
public class MainActivity extends BaseSettingsActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
           ...
           // Log.i("MaiActivity","当前app类信息"+ JSONArray(info));
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent wxIntent = getPackageManager().getLaunchIntentForPackage(
                        WechatAccessbilityJobCopy.WECHAT_PACKAGENAME);
                if (wxIntent != null) {
                    try {
            ...
            notificationPref.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
                ...
                public boolean onPreferenceChange(Preference preference, Object newValue) {
                    if (Build.VERSION.SDK_INT < Build.VERSION_CODES.JELLY_BEAN_MR2) {
                        Toast.makeText(getActivity(), "该功能只支持安卓5.0以上的系统", Toast.LENGTH_SHORT).show();
                        return false;
                    }
...
/*           findPreference("OPEN_REAL_MACHINE").setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                @Override
                public boolean onPreferenceClick(Preference preference) {
                    startActivity(new Intent(getActivity(), RealMachineTestActivity.class));
                    return true;
                }
            });*/
           findPreference("OPEN_REAL_MACHINE").setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
